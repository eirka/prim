// replaces matching text nodes with elements
// https://github.com/padolsey/findAndReplaceDOMText
angular.module('prim').factory('FindAndReplace', function() {
    ...
    var NON_CONTIGUOUS_PROSE_ELEMENTS = {
    ...
    var NON_INLINE_PROSE = function(el) {
    ...
    Finder.prototype = {
        ...
        replaceMatch: function(match, startPortion, innerPortions, endPortion) {
            ...
            if (matchStartNode === matchEndNode) {
                ...
                var replaceNode = function(portion, innerNode) {
                    return function() {
                ...
                for (var i = 0, l = innerPortions.length; i < l; ++i) {
                    ...
                    this.reverts.push(replaceNode(portion, innerNode));
